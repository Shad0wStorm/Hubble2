...
//----------------------------------------------------------------------
//! ButtonActionInstall, handles the text and action of installing a game
//
//! Author:     Alan MacAree
...
namespace Launcher
{
    ...
    /// </summary>
    internal class ButtonActionInstall : ButtonAction
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        public ButtonActionInstall( LauncherWindow launcherWindow, ProductUserCtrl _productUserCtrl )
            : base( launcherWindow )
        {
        ...
        {
            return LocalResources.Properties.Resources.BTNT_LauncherInstall;
        }
