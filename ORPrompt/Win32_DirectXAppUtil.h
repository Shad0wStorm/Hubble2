...
struct Scene
{
    ...
    void Init()
    {
		...
		*/
		...
		TriangleSet message;
		message.AddQuad(
			Vertex(XMFLOAT3(-5.0f, -5.0f, -5.0f), 0xFF0000FF, 0.0f, 0.0f),
			Vertex(XMFLOAT3(-5.0f, 5.0f, -5.0f), 0xFFFF0000, 0.0f, 1.0f),
			Vertex(XMFLOAT3(5.0f, -5.0f, -5.0f), 0xFFFFFFFF, 1.0f, 0.0f),
			Vertex(XMFLOAT3(5.0f, 5.0f, -5.0f), 0xFF00FF00, 1.0f, 1.0f)
			);
		Add(
			new Model(&message, XMFLOAT3(0, 0, 0), XMFLOAT4(0, 0, 0, 1),
				new Material(
