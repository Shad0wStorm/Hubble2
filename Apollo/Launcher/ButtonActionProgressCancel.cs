...
//----------------------------------------------------------------------
//! ButtonActionInstall, handles the text and action of cancelling an
//                      install.
//
//! Author:     Alan MacAree
//! Created:    07 Nov 2022
...
namespace Launcher
{
    ...
    /// </summary>
    internal class ButtonActionProgressCancel : ButtonActionProgressBar
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        public ButtonActionProgressCancel( LauncherWindow launcherWindow, ProductUserCtrl _productUserCtrl )
            : base( launcherWindow )
        {
        ...
        {
            return LocalResources.Properties.Resources.BTNT_CancelInstallation;
        }
        ...
        public override bool PerformAction( object _sender )
        {
            ...
            if ( launcherWindow != null )
            {
                ...
                {
                    if ( (cobraBayView.Monitor != null) && (cobraBayView.Monitor.RequestCancellation == false) )
                    {
                        bool cancel = m_productUserCtrl.YesNoQuery(LocalResources.Properties.Resources.CancelDownloadDetails, LocalResources.Properties.Resources.CancelDownloadTitle);
                        if ( cancel )
                        {
                            ...
                            if ( (cobraBayView.Monitor != null) && (cobraBayView.Monitor.RequestCancellation == false) )
                            {
                                cobraBayView.Monitor.RequestCancellation = true;
                                wasActionPerformedOkay = true;
                            }
                            else
                            {
                                wasActionPerformedOkay = false;
                            }
                        }
                    }
                }
